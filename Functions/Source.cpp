...
void main()
{
	...
	*/
	...
	Если функция с разыми типами данных ведёт себя одинаково то её можно шаблонизировать.
	Если мы хотим обеспечить особое поведение функции с определёнам типом данных то её нужно перегрузить для этого типа данных
	*/
